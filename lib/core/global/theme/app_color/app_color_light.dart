...
const List<Color> homeBg = [
  ...
  Color.fromRGBO(111, 82, 70, 0.95)
];
const List<Color> fromToBottomSheetBg = [
...
const Color paymentTextFieldColor = Color.fromRGBO(217, 217, 217, 1);
const Color paymentTextFieldTextColor = Color.fromRGBO(75, 75, 75, 0.94);
...
const Color paymentBg = Color.fromRGBO(78, 64, 57, 0.51);
const List<Color> ticketColor = [Color(0xff6A6259), Color(0xff71635B)];
